...
# Global parameters
NCPUS=3                           # Number of CPUs to use. A lot of the steps are parallelized (int, 1+)
...
CROP_LENGTH=420 # Cut reads to this length after filtering. Just under amplicon length
